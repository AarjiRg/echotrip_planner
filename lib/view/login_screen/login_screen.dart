        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              Text("Please sign in to continue", style: TextStyle(color: Colors.green[700])),
              SizedBox(height: 30),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text("Remember me", style: TextStyle(color: Colors.green[700])),
                    ],
                  ),
                  TextButton(
                    onPressed: () {},
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text("Sign Up", style: TextStyle(color: Colors.green[800])),
                  ),
                ],
              ),
            ],
